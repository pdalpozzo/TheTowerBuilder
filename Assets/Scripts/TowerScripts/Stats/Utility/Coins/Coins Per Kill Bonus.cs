...
public class CoinsPerKillBonus : Stat
{
    ...
    // × (1 + coin bonus enhancement)                       - already in enhancement value
    // × (1 + coin bonus perk base [0.15] × perk quantity)  - already in perk value
    // × (trade-off perk [1.8] × (1 + trade-off lab))       - already in perk value
